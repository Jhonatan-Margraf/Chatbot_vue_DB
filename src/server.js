...
const API_KEY = "AIzaSyCKE9Mq0SiUxY6U9bTQ2ZbcRKLiFqe_Wdk";
...
async function connectToDatabase() {
  const uri = "mongodb+srv://Jhonatan:99919228Jhonatan*@chatbot.wdvj54i.mongodb.net/?retryWrites=true&w=majority&appName=chatbot"; // Substitua a <password> pela sua senha
  const client = new MongoClient(uri, { useNewUrlParser: true, useUnifiedTopology: true });

  try {
    await client.connect();
    console.log("Conectado ao MongoDB Atlas");
    return client.db("chatbot"); // Use o nome do banco de dados desejado aqui
  } catch (error) {
